...
void PMenu_Open(edict_t *ent, pmenu_t *entries, int cur);
...
/*Savvy i added in stinger upgrade(s)*/
extern pmenu_t  upgrade_menu_stinger[];
/*Savvy i added in shock trooper upgrade(s)*/
extern pmenu_t  upgrade_menu_shock_trooper[];
